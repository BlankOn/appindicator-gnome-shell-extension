#!/bin/sh
EXT_NAME="appindicatorsupport@rgcjonas.gmail.com"
...
AUTOSTART_FILE="$HOME/.config/autostart/appindicator-extension-update.desktop"
...
PKG_VERSION=$(dpkg-query -W -f='${Version}' appindicator-gnome-shell-extension 2>/dev/null || echo "unknown")
